...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.05 * COIN;	// 5%
...
static const uint256 hashGenesisBlock("0x00000b20ede6fe8f8c1f612214c937c269a6b052fd2b7e07bbd1c3ecba563263");
static const uint256 hashGenesisBlockTestNet("0x00000b20ede6fe8f8c1f612214c937c269a6b052fd2b7e07bbd1c3ecba563263");
...
public:
    ...
    {
        // Ricecoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Ricecoin: get transaction coin age
...
public:
    ...
    // Ricecoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Ricecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Ricecoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Ricecoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Ricecoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Ricecoin: block index flags
    enum  
    {
